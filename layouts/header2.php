<header>
       ...
       <a href="../librairie/categorieLivres.html.php"><img src="../images/logo.png" alt="" width="90px" height="90px"></a>
        ...
        <div class=" edges ">
           ...
           <h3><a href="../librairie/vue/categorieLivres.html.php">Accueil</a></h3>
       </div>
        </div>
        <div class=" end mr-3">
           <a href="../librairie/vue/profil.html.php"> <img src="../images/profil.png" alt="" width="50px" height="50px"></a>
        </div>
       </div>
